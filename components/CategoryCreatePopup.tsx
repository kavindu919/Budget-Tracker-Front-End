        ...
        <div className="w-full max-w-2xl rounded-lg bg-white shadow-xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-3 p-6">
            <div className="flex w-full flex-1 flex-col gap-3 md:flex-row">
              ...
              <div className="flex w-full flex-col gap-3 rounded-lg border border-slate-300 px-3 py-4 md:w-1/2">
                <header className="flex flex-col items-start justify-start gap-1">
                  <h4 className="text-base font-medium">Category Settings</h4>
                  <h5 className="text-sm font-normal text-slate-400">
          ...
          <div className="flex items-center justify-end gap-3 px-6 pb-4 b">
            <button
              onClick={handleClose}
              disabled={loading}
